...
namespace Troubleshooter
{
    public partial class frmConsulta : Form
    {
        ...
        {
            ttipDiag.SetToolTip(btnBusca, "Buscar");   
        }

        private void btnGerar_MouseHover(object sender, EventArgs e)
        {
            ttipDiag.SetToolTip(btnGerar, "Gerar script");
        }

        private void btnLogout_MouseHover(object sender, EventArgs e)
        {
            ttipDiag.SetToolTip(btnLogout, "Desconectar");
        }

        private void dtgBusca_RowHeaderMouseDoubleClick(object sender, DataGridViewCellMouseEventArgs e)
        {
        }
        private void dtgBusca_CellMouseEnter(object sender, DataGridViewCellEventArgs e)
        {            
        }
    }
}
