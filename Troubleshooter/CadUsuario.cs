...
{    
    public partial class frmCadastro : Form
    {
        ...
        private void pctVisib_MouseHover(object sender, EventArgs e)
        {
            ToolTip ttp = new();
            ttp.SetToolTip(pctVisib, "Exibir senha");
        }

        private void pctNoVisib_MouseHover(object sender, EventArgs e)
        {
            ToolTip ttp = new();
            ttp.SetToolTip(pctNoVisib, "Ocultar senha");
        }
    }
}